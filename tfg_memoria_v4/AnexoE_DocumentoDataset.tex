...
\item \texttt{enriched\_captions/}: dataset enriquecido para la
rama contrastiva de Dermapixel R0
...
casos con imagen ---de los cuales 669 se retienen en el \emph{split}
de producción del dataset--- sobre 698 casos catalogados en total.
