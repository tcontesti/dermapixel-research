...
codificadores visuales modernos, las diferencias de rendimiento
...
controlado y homogéneo ---sondeo lineal con idéntica configuración
sobre los mismos datasets, equidad evaluada entre los mismos cinco
codificadores sobre una partición común, y test de DeLong pareado
...
(repositorio reproducible, \ref{cap:repo}, sección~\ref{sec:repo-ablaciones}) supera al sondeo lineal en
...
cola larga marcada a nivel L3, por lo que las cifras derivadas se
...
relevante está, por tanto, internalizado en el codificador, y el
...
DDI ($N_{\mathrm{train}} = 427$), el sondeo lineal supera al ajuste
...
marginal. La asimetría admite una explicación común: el ajuste fino
...
sobreajuste; y ajuste fino denso con la receta original sólo con
...
especialista ajustado (PanDerm Base con ajuste fino y \emph{test-time
...
sondeo lineal de este trabajo sobre los datasets compartidos (HAM10000,
...
En segmentación, SAM2.1-Large con \emph{fine-tuning} del decodificador
...
decodificador, que concentra la capacidad de ajuste y reduce el
...
alineada con su desarrollo, mientras que la sensibilidad al tokenizador
...
homogénea entre cinco familias de codificadores bajo un mismo protocolo,
...
dataset armonizado, mientras que el nivel L3 conserva la cola larga
...
L1, lo que da robustez frente a la incertidumbre de la cola larga sin
...
DermapixelAI~1.0, cuya cola larga L3 obliga a leer ese nivel como
...
preentrenamiento de dominio, la saturación temprana del sondeo lineal,
