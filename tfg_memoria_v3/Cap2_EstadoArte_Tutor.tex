...
capítulo \emph{Materiales y métodos} (en preparación) y cuyos resultados se presentan
cuantitativamente en el capítulo \emph{Resultados} (en preparación), se sitúa
