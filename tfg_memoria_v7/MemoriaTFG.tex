...
%%%%%%% Apéndice
% El material complementario (antiguos anexos A-J: tareas y
% reproducibilidad, tablas extendidas, pipeline y datasheet del
% dataset, declaración de uso de IA, Sparse Autoencoders, modelos
% de lenguaje multimodales, prototipo DermApIxel y ablaciones) se
% publica en un repositorio reproducible y se describe en un único
% anexo-puntero.
\appendix
