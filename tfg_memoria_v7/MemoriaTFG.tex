...
\documentclass[spanish, GINF, openany]{TFGEPSUIB}
...
\include{Cap_Dermapixel}
\include{Cap_Prototipo}
...
%%%%%%% Apéndices
% Dos apéndices: (A) anexo-puntero al repositorio público reproducible,
% donde se centraliza el material complementario (tablas extendidas,
% pipeline y datasheet del dataset, Sparse Autoencoders, modelos de
% lenguaje multimodales, prototipo DermApIxel y ablaciones); y (B) la
% declaración completa de uso de herramientas de inteligencia artificial.
\appendix
\include{AnexoRepo_MaterialComplementario}
