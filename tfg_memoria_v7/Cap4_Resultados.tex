...
clínico grande conviene hacer \emph{fine-tuning}, pero con pocos datos
es más seguro quedarse con el \emph{encoder} congelado, porque el
\emph{fine-tuning} tiende a sobreajustar. Este resultado justifica la
...
rendimiento, porque el \emph{encoder} preentrenado aporta la mayor
