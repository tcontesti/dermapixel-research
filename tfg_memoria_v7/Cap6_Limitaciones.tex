...
\emph{bootstrap} ---incluido el \emph{gap}~I-VI de cada codificador---
...
pareados entre codificadores sobre tres \emph{endpoints} binarios
...
La consecuencia operativa es que la superioridad de los codificadores de
