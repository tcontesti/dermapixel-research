...
Sobre el nivel L3, el fine-tuning denso parcial no supera al sondeo
lineal congelado (BAcc $0{,}184$ en ambos): la long tail severa del
...
sobre la que se calibra \emph{H6}. La long tail tampoco se rellena
