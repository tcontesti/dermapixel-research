...
Llegamos a la parte que más ilusión hacía: el primer modelo propio.
...
En lo técnico, Dermapixel R0 es una adaptación mediante
LoRA~\cite{lora} de PanDerm Large sobre DermapixelAI~1.0 ---adaptar un
modelo preexistente, no preentrenar a escala---. Entrena
