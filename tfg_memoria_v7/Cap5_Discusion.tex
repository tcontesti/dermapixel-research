...
DDI ($N_{\mathrm{train}} = 427$), el linear probe supera al ajuste
fino en las cuatro métricas, con un descenso de AUROC
...
tres estrategias en una regla escalonada por volumen de datos: sondeo
lineal con $N_{\mathrm{train}} \lesssim 500$; LoRA en el régimen
