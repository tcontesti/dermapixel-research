...
El primer protocolo adapta SAM2.1-Large mediante fine-tuning
denso de su decoder: se ajustan el decoder de máscaras y
...
fine-tuning y un \emph{Convolutional AutoEncoder} (CAE-seg)
