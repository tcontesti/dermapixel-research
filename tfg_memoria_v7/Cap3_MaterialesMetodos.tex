...
caja ---una U-Net con encoder ResNet-101 preentrenado en
ImageNet--- se evalúa sin recibir \emph{bounding box} para aislar la
contribución del \emph{prompt}; esta misma U-Net desempeña además un
segundo papel ---es el localizador que, en el modo automático del
prototipo, genera la caja que alimenta al segmentador (cascada
U-Net~$\to$~caja~$\to$~MedSAM2-tiny, sección~\ref{sec:seg-robustez})---.
La estabilidad de la mejor
