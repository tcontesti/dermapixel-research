...
Dentro de ese objetivo conviven dos enfoques complementarios. El
primero es el papel de los modelos fundacionales para mejorar el
diagnóstico a partir de la imagen. El segundo, menos explorado, es el
uso del texto clínico asociado a cada imagen como contexto para la
predicción: la mayoría de los trabajos se apoyan únicamente en la
imagen, y la hipótesis de fondo es que incorporar el lenguaje natural
que acompaña a cada caso ---la descripción, el razonamiento, la
historia--- puede mejorar el reconocimiento de patologías, en especial
en fotografía clínica y más allá del melanoma.
