...
---fotografía clínica, dermatoscopia e histopatología---. Hasta ahora,
los sistemas de inteligencia artificial dermatológica han sido en su
mayoría \emph{especializados}: un modelo entrenado para una tarea
concreta, típicamente distinguir melanoma de no-melanoma sobre
dermatoscopia. En los últimos años ha emergido un paradigma distinto,
el de los \emph{modelos fundacionales} ---modelos de gran escala,
preentrenados sobre un volumen amplio de datos y reutilizables,
mediante adaptación, en múltiples tareas posteriores---, que aspira a
sustituir ese mosaico de modelos por una base común, aunque su
adopción en la práctica clínica es todavía incipiente.
...
desarrollado su migración a una pila tecnológica propia ---la plataforma
resultante, \emph{Dermapixel 5.0}, fue distinguida con la \emph{Beca de
Innovación e Inteligencia Artificial} de la Academia Española de
Dermatología y Venereología (AEDV), dotada con 10\,000~euros para su
puesta en producción, en el 53.\textsuperscript{er} Congreso Nacional de
Dermatología y Venereología (Maspalomas, mayo de 2026)---. La segunda
...
Dentro de ese objetivo conviven dos enfoques complementarios, que en
dermatología encarnan los dos modelos fundacionales abiertos de
referencia. El primero es el papel de los modelos centrados en la
imagen ---como PanDerm--- para mejorar el diagnóstico a partir de la
propia fotografía o dermatoscopia. El segundo, menos explorado, es el
uso del texto clínico asociado a cada imagen como contexto para la
predicción ---la vía que abren los modelos vision-language como
DermLIP, que aprenden a relacionar imagen y texto---: la mayoría de los
trabajos se apoyan únicamente en la imagen, y la hipótesis de fondo es
que incorporar el lenguaje natural que acompaña a cada caso ---la
descripción, el razonamiento, la historia--- puede mejorar el
reconocimiento de patologías, en especial en fotografía clínica y más
allá del melanoma.
