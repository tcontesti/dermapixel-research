...
descrita en sección~\ref{sec:anexod-verificacion});
...
(sección~\ref{sec:repo-reproducibilidad}) y verificables de forma
independiente.
...
(capítulo~\ref{cap:resultados}, sección~\ref{sec:llm-results}), no
herramientas auxiliares de redacción. Su uso se documenta en los
protocolos experimentales correspondientes
(sección~\ref{sec:llm}). La declaración del presente anexo se refiere
