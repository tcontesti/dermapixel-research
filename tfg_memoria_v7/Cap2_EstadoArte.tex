...
---\emph{Facebook AI Similarity Search}, la biblioteca de referencia
de Meta para búsqueda de similitud y agrupamiento sobre grandes
colecciones de vectores densos--- y estructuras basadas en grafos del
tipo Hierarchical Navigable Small Worlds permiten consultas en el
orden de $10^2$
