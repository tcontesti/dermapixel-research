...
cambiaron esa lógica: un mismo codificador, preentrenado a gran
escala, se reutiliza en muchas tareas mediante adaptación ligera. En
dermatología, las referencias abiertas son PanDerm ---un codificador
...
codificadores generalistas (DINOv2), modelos contrastivos
...
De este panorama se desprenden las carencias que motivan el trabajo.
...
modelos. Casi todo el material y los codificadores de texto están en
...
De estas carencias se desprende el punto de partida de este trabajo:
una evaluación experimental homogénea e independiente de los modelos
fundacionales dermatológicos con pesos públicos, sobre un conjunto
común de datasets externos y de tareas. Hacerla comparable exigirá
armonizar las taxonomías heterogéneas de esos datasets y auditar su
posible solapamiento con los datos de preentrenamiento. Esta
evaluación es el primer paso necesario: solo a partir de lo que revele
---qué ofrecen y qué les falta estos modelos--- podrá decidirse cómo
continuar.
